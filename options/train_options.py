...
class TrainOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--save_every_e', type=int, default=every_e_interval, help='Frequency of saving models (by epoch)')
        ...
        self.parser.add_argument('--save_latest', type=int, default=50, help='Frequency of saving models (by iteration)')
