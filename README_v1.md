...
### Diffusion model
The Diffusion model has been trained on HumanML3D dataset. The model is a standard stable diffusion with a transformer backend. Currently experimenting with different regularizers to ensure geometric plausibility of motions.
